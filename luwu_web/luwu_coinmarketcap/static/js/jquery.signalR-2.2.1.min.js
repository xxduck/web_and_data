...
(function (n, t, i) {
    ...
    r.fn = r.prototype = {
        ...
        keepAliveWarnAt: 2 / 3,
        start: function (i, h) {
            var a = this, v = {pingInterval: 3e5, waitForPageLoad: !0, transport: "auto", jsonp: !1}, d,
                y = a._deferral || n.Deferred(), b = t.document.createElement("a"), k, g;
    ...
    i.fn = i.prototype = {
        init: function (n, t) {
            ...
            var i = this, r = i.connection, e = n.makeArray(arguments).slice(1), c = s(e, h),
